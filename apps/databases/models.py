...
class DataBase_Server_Config(models.Model):
    ...
    db_assets = models.ForeignKey('assets.Asset', related_name='database_total', on_delete=models.CASCADE,
    ...
    class Meta:
        db_table = 'fdommp_database_server_config'
        default_permissions = ()
        permissions = (
...
class Database_Detail(models.Model):
    db_server = models.ForeignKey('DataBase_Server_Config', related_name='databases', on_delete=models.CASCADE,
                                  verbose_name='db_server_id')
    ...
    class Meta:
        db_table = 'fdommp_database_detail'
        default_permissions = ()
...
class Database_Table_Detail_Record(models.Model):
    ...
    class Meta:
        db_table = 'fdommp_database_table_detail'
        default_permissions = ()
...
class Database_Group(models.Model):
    ...
    class Meta:
        db_table = 'fdommp_database_group'
        default_permissions = ()
...
class SQL_Execute_Histroy(models.Model):
    ...
    class Meta:
        db_table = 'fdommp_sql_execute_histroy'
        default_permissions = ()
        permissions = (
...
class Custom_High_Risk_SQL(models.Model):
    ...
    class Meta:
        db_table = 'fdommp_custom_high_risk_sql'
        default_permissions = ()
        permissions = (
...
class Soar_Config(models.Model):
    ...
    blacklist = models.CharField(max_length=500, blank=True, null=True,verbose_name='黑名单列表')
    sampling = models.NullBooleanField(default='',verbose_name='数据采样')
    tableallowengines = models.CharField(max_length=30, blank=True, null=True,verbose_name='数据库引擎',default='InnoDB')
