# Generated by Django 2.1.3 on 2019-09-05 11:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.SmallIntegerField(choices=[(0, '虚拟机'), (1, 'PC服务器'), (2, '刀片机'), (3, '小型机')], default=0, verbose_name='服务器类型')),
                ...
                ('username', models.CharField(blank=True, max_length=100, null=True, verbose_name='管理账户')),
                ('passwd', models.CharField(blank=True, max_length=100, null=True, verbose_name='管理密码')),
                ('sshport', models.DecimalField(decimal_places=0, default=22, max_digits=6, verbose_name='ssh端口')),
