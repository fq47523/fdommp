...
class Server(models.Model):
    ...
    username = models.CharField(max_length=100, blank=True, null=True,verbose_name="管理账户")
    passwd = models.CharField(max_length=100, blank=True, null=True,verbose_name="管理密码")
    sshport = models.DecimalField(max_digits=6, decimal_places=0, default=22, verbose_name="ssh端口")
    keyfile = models.SmallIntegerField(blank=True, null=True,verbose_name="秘钥文件")
